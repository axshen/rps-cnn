...
def main():
    ...
    write_file = "/Users/austin.shen/Dropbox/UWA/ICRAR_Kenji/plots/paper/FIG3.pdf"
    plot_title = ""
    ...
    utils.visualisation.grid_images(
        data_array, plot_title=plot_title, titles=titles, plot_labels=None, x_labels=x_labels, y_labels=y_labels, 
